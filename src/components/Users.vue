...
export default {
  data() {
    ...
    var checkMobile = (rule, value, cb) => {
      // 正则表达式
      const regMobile = /^(0|86|17915)?(13[0-9]|15[0123456789]|17[678]|18[0-9]|14[57])[0-9]{8}$/
    ...
    return {
      ...
      addFormRules: {
        ...
        email: [
          { required: true, message: '请输入E-mile', trigger: 'blur' },
          {
  ...
  methods: {
    ...
    async saveroleInfo() {
      ...
      if (res.meta.status !== 200) {
        return this.$message.error('更新角色消息失败')
      }
      this.$message.success('更新角色消息成功')
      this.getUserList()
